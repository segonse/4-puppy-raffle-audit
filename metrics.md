...
| ---- | ------ | --------------- | ---------- | ----- | ------ | ----- | ------------- | -------------- | ------------ | 
| 📝 | ./src/PuppyRaffle.sol | 1 | **** | 216 | 216 | 143 | 46 | 111 | **<abbr title='Payable Functions'>💰</abbr><abbr title='Uses Hash-Functions'>🧮</abbr>** |
| 📝 | **Totals** | **1** | **** | **216**  | **216** | **143** | **46** | **111** | **<abbr title='Payable Functions'>💰</abbr><abbr title='Uses Hash-Functions'>🧮</abbr>** |
...
- **Comment-to-Source Ratio:** On average there are`3.11` code lines per comment (lower=better).
- **ToDo's:** `0` 
...
|-------------|--------------|
| ./src/PuppyRaffle.sol | [object Promise] |
